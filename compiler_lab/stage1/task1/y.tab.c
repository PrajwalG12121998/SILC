...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 13 "exprtree.y" /* yacc.c:1646  */
    {
(yyval) = (yyvsp[0]);
printf("Prefix :");prefix_form((yyvsp[-1]));printf("\n"); 
printf("Postfix: ");postfix_form((yyvsp[-1])); printf("\n");
exit(1);
}
...
#line 27 "exprtree.y" /* yacc.c:1906  */
