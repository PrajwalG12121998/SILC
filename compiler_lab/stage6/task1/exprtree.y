...
FDef : TypeName FID '(' ParamList ')' '{' LDeclBlock Body '}'  { $$=makeFuncDefNode(currType,currFunc,$8,$4);
...
FIELD : ID '.' ID    {$1->cond = $3; $3->cond=NULL;$$=$1;}
      | FIELD '.' ID {$1->cond = $3; $$= $1;}
      ;
