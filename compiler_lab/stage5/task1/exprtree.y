...
%%
Program : GDeclBlock FDefBlock MainBlock  { printSymbolTable(); printf("Executed successfully\n");}
...
FDef : TypeName FID '(' ParamList ')' '{' LDeclBlock Body '}'  {  }                                
          ;
...
Main : INTEGER MAIN   {currFunc = strdup("main");lTableInstall("main");}
     ;
Body      : BEGINS Slist Retstmt END     
          ;
